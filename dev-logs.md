...
>> chyyuu 04182018 感觉编译器会成为你们的一个障碍，如果你们有对编译器比较熟悉的，建议有一人专门对付编译器，自己写，参考某个简单的C编译器写，或基于LLVM，扩展一个此CPU的后端。我建议是扩展后端，2016年有一组学生做过，助教朱奉民负责设计CPU指令，另外一个同学初步完成了编译器后端。
